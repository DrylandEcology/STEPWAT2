 ...
 */
   ...
   while( GetALine(f, inbuf) ) {
      switch(lineno) {
        ...
        case 6:  v->TminAccu2 = atof(inbuf);break;
        case 7:  v->TmaxCrit = atof(inbuf);break;
        case 8:  v->lambdasnow = atof(inbuf);break;
        case 9:  v->RmeltMin = atof(inbuf);break;
        case 10:  v->RmeltMax = atof(inbuf);break;
        case 11:  v->slow_drain_coeff = atof(inbuf);break;
        case 12:  v->evap.xinflec     = atof(inbuf);  break;
        case 13:  v->evap.slope     = atof(inbuf);  break;
        case 14:  v->evap.yinflec   = atof(inbuf);  break;
        case 15:  v->evap.range    = atof(inbuf);  break;
        case 16:  v->transp.xinflec  = atof(inbuf);  break;
        case 17:  v->transp.slope  = atof(inbuf);  break;
        case 18:  v->transp.yinflec = atof(inbuf);  break;
        case 19:  v->transp.range  = atof(inbuf);  break;
        case 20:  v->latitude      = atof(inbuf);  break;
        case 21:  v->altitude        = atof(inbuf);  break;
        case 22:  v->bmLimiter		= atof(inbuf); break;
        case 23:  v->t1Param1		= atof(inbuf); break;
        case 24:  v->t1Param2		= atof(inbuf); break;
        case 25:  v->t1Param3		= atof(inbuf); break;
        case 26:  v->csParam1		= atof(inbuf); break;
        case 27:  v->csParam2		= atof(inbuf); break;
        case 28:  v->shParam		= atof(inbuf); break;
        case 29:  v->meanAirTemp	= atof(inbuf); break;
        case 30:  v->stDeltaX		= atof(inbuf); break;
        case 31:  v->stMaxDepth     = atof(inbuf); break;
        case 32:  v->use_soil_temp  = itob(atoi(inbuf)); break;
        default:
            if (lineno > 32+MAX_TRANSP_REGIONS) break; /* skip extra lines */
